    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-600 to-primary-800 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Sistema DICRI</h1>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <ul className="text-xs text-blue-700 space-y-1">
              <li>
                • Administrador:
                <code className="bg-blue-100 px-1 rounded ml-1">admin</code>
                <code className="bg-blue-100 px-1 rounded ml-1">Admin123!</code>
              </li>
              ...
              <li>
                ...
                <code className="bg-blue-100 px-1 rounded ml-1">Coord123!</code>
              </li>

              <li>
                • Técnico:
                <code className="bg-blue-100 px-1 rounded ml-1">tecnico1</code>
                <code className="bg-blue-100 px-1 rounded ml-1">Tecn123!</code>
              </li>
            </ul>
          </div>
        </div>
